...
using AnimalSearchService.Configuration.IoC;
...
namespace AnimalSearchService
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "AnimalSearch Api", Version = "v1" });
            });
        ...
        public void ConfigureContainer(ContainerBuilder autoFacBuilder)
        {
            ...
            autoFacBuilder.RegisterModule(new ElasticSearchModule
            {
                ConfigurationOptions = configurationOptions
            });
